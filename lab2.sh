...
#Giving network address and gateway 
ip netns exec ns1 ifconfig veth-ns1 192.168.11.100/24 up
ip netns exec router ifconfig veth-router-ns1 192.168.11.1/24 up

ip netns exec ns2 ifconfig veth-ns2 192.168.12.100/24 up
ip netns exec router ifconfig veth-router-ns2 192.168.12.1/24 up

ip netns exec ns3 ifconfig veth-ns3 192.168.13.100/24 up
ip netns exec router ifconfig veth-router-ns3 192.168.13.1/24 up


ip netns exec ns4 ifconfig veth-ns4 192.168.14.100/24 up
...
ip netns exec ns1 route add -net 0.0.0.0 gw 192.168.11.1 veth-ns1
ip netns exec ns2 route add -net 0.0.0.0 gw 192.168.12.1 veth-ns2
ip netns exec ns3 route add -net 0.0.0.0 gw 192.168.13.1 veth-ns3
ip netns exec ns4 route add -net 0.0.0.0 gw 192.168.14.1 veth-ns4
...
# Execute test cases
ip netns exec ns1 ping -c 1 192.168.12.100
ip netns exec ns1 ping -c 1 192.168.13.100
ip netns exec ns1 ping -c 1 192.168.14.100

ip netns exec ns2 ping -c 1 192.168.11.100
ip netns exec ns2 ping -c 1 192.168.13.100
ip netns exec ns2 ping -c 1 192.168.14.100

ip netns exec ns3 ping -c 1 192.168.11.100
ip netns exec ns3 ping -c 1 192.168.12.100
ip netns exec ns3 ping -c 1 192.168.14.100

ip netns exec ns4 ping -c 1 192.168.11.100
ip netns exec ns4 ping -c 1 192.168.12.100
ip netns exec ns4 ping -c 1 192.168.13.100
